...
def printHelp():
    print "getInteriorResidues.py [input pdb] [chain file] [surface cutoff] [margin] [center axis unit vector]"
...
def getInterior(chain, protein, centralAxis, minMax, margin, rmax=65, heavyMargin = 3):
    residueIndices = []
    count = 0
...
def main():
    ...
    for chainList in chains:
        residueIndices = getInterior(chainList[0], p, centralAxis, minMax, margin)
        for c in chainList:
            print c
